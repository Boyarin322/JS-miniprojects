...
const filtredInventors = inventors.filter(function(item){
    return item.year < 1600 && item.year >=1500;
})
// console.table(filtredInventors);

// Array.prototype.map()
// 2. Give us an array of the inventors first and last names
const mapedInventors = inventors.map(function (item){
...
const rInventors = inventors.reduce((total, inventor)=>{
    return total =total + (inventor.passed-inventor.year);
}, 0)
// console.log(rInventors);
